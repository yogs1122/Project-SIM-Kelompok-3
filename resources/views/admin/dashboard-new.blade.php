            ...
            <div class="bg-white shadow-sm rounded-lg">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl shadow">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="bg-blue-500 p-4 rounded-lg text-white text-2xl">👥</div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl shadow">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="bg-green-500 p-4 rounded-lg text-white text-2xl">💳</div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl shadow">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="bg-purple-500 p-4 rounded-lg text-white text-2xl">🏪</div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 p-6 rounded-xl shadow">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="bg-yellow-500 p-4 rounded-lg text-white text-2xl">📈</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <a href="{{ route('admin.users.index') }}" class="p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition">
                        ...
                        <a href="{{ route('admin.transactions.index') }}" class="p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition">
                            <div class="flex items-center mb-4">
